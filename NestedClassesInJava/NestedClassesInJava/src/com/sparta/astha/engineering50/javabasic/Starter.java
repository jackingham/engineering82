...
public class Starter {
    ...
    private static void runAnonymousClassPractice() {
        ...
        anonymousClassesPractice.spartanOnsite.getGraduationStatus();
    }
    ...
    public static void runAnonymousClass(){
       // ImplementingAnonymousClass implementingAnonymousClass=new ImplementingAnonymousClass();
        ...
        implementingAnonymousClassesPractice.londonAcademy.aboutMethod();
        implementingAnonymousClassesPractice.spartanOnsite.getGraduationStatus();
